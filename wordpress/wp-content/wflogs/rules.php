...
$this->rules[869] = wfWAFRule::create($this, 869, NULL, 'priv-esc', '100', 'WAF-RULE-869', 0, 'block', new wfWAFRuleComparisonGroup(new wfWAFRuleComparisonGroup(new wfWAFRuleComparison($this, 'match', '/wp-json[\\/]+llms[\\/]+v1[\\/]+(students|instructors)/i', array(wfWAFRuleComparisonSubject::create($this, 'request.path', array (
...
$this->rules[870] = wfWAFRule::create($this, 870, NULL, 'priv-esc', '100', 'WAF-RULE-870', 0, 'block', new wfWAFRuleComparisonGroup(new wfWAFRuleComparison($this, 'versionLessThanEqualTo', '6.15.9', array(wfWAFRuleComparisonSubject::create($this, array('wordpress.plugins', 'the-events-calendar'), array (
)))), new wfWAFRuleLogicalOperator('AND'), new wfWAFRuleComparison($this, 'lengthGreaterThan', '0', array(wfWAFRuleComparisonSubject::create($this, array('request.queryString', 'tribe_promoter_auth_token'), array (
)),
wfWAFRuleComparisonSubject::create($this, array('request.body', 'tribe_promoter_auth_token'), array (
)),
wfWAFRuleComparisonSubject::create($this, array('request.jsonBody', 'tribe_promoter_auth_token'), array (
))))));
