...
<div id="page" class="whole-page">
	...
	<main id="main" class="site-content">
		<article class="help-archive help-archive--wpam">
      <section class="help-archive__inner">
        <div class="container__inner reset-padding">
          <?php
              ...
              $pan->append("WealthPark Support", home_url()."/asset-management/help/");
              $pan->append($term->name, "#");
              $pan->build();
          ?>
        </div>
      </section>
      ...
      <div class="container__inner reset-padding">
        <h2 class="help-list__headline--large"><?=$term->name?></h2>
          <p class="help-list__description">
            <?php _e("owner-help.help-list__description.former", 'wp-next-landing-page'); ?>
            「<?=$term->name?>」
            <?php _e("owner-help.help-list__description.latter", 'wp-next-landing-page'); ?>
          </p>
            ...
            <?php
              ...
              if ($query->have_posts()) {
                  while ($query->have_posts()) {
                      $query->the_post();
                      $terms = get_the_terms(get_the_ID(), "help_am_topics");
                      echo "
