<?php
/*
Template Name: Service Page-  Asset Management Contact WP AM
*/
?>
<!DOCTYPE html>
...
<title>Contact UK | Asset Management WealthPark</title>
...
<!-- <div class="wealth-park-triangle wealth-park-triangle--am"> -->
  <?php include "header-common.php" ?>
  <section class="page-name">
    <div class="page-name__inner page-name__inner--form">
      <h1 class="page-name__title--form">
        Asset Management WealthPark
      </h1>
      <p class="page-name__caption">
  ...
  <section class="container__inner form-section">
    <div class="breadcrumb">
      <ul class="breadcrumb__list">
        ...
        <li class="breadcrumb__item"><span class="breadcrumb__link">Asset Management WealthPark Contact</span></li>
      </ul>
    </div>
    <!-- <p class="form-section__note"><?php _e("contact.note", 'wp-next-landing-page'); ?></p> -->
    <?php echo do_shortcode( '[contact-form-7 id="5976" title="WPAM_UK"]' ); ?>
    <p class="form-section__rule">
      <a href="<?php echo esc_url(home_url('/')); ?>corporate/terms-of-use/">terms of use</a> / <a href="<?php echo esc_url(home_url('/')); ?>corporate/privacy-policy/">privacy policy</a>
    </p>
  </section>
<!-- </div> -->
<footer>
