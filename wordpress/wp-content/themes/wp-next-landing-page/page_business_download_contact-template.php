<?php
/*
Template Name: Service Page - Business - Download - Form Template
*/
?>
<!DOCTYPE html>
...
<title><?=get_field("document_name") ?> | WealthParkビジネス</title>
<meta name="description" content="<?php _e("wpb_dl-form_meta-description", 'wp-next-landing-page'); ?>">
<meta property="og:title" content="Download | WealthPark Business">
      ...
      <section class="form-section--salesforce form-section--salesforce-half">
        ...
        <div class="form-block form-block--column">
          ...
          <div class="form-block__item form-block__item--col">
            <!-- <p>
            <label>
              <input name="managed_units" type="radio" value="賃貸管理業（～999室）" required/> 賃貸管理業（～999室）
            </label>
            </p>
            <p>
            <label>
              <input name="managed_units" type="radio" value="賃貸管理業（1,000室～9,999室）"/> 賃貸管理業（1,000室～9,999室）
            </label>
            </p>
            <p>
            <label>
              <input name="managed_units" type="radio" value="賃貸管理業（10,000室〜）  "/> 賃貸管理業（10,000室〜） 
            </label>
            </p>
            <p>
            <label>
              <input name="managed_units" type="radio" value="不動産業（開発、マンション管理）"/> 不動産業（開発、マンション管理）
            </label>
            </p>
            <p>
            <label>
