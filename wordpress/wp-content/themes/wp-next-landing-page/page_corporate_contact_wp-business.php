<?php
/*
Template Name: Corporate Site - Contact - WP Business
*/
?>
<!DOCTYPE html>
...
<div class="wealth-park-triangle">
  ...
  <section class="page-name">
    <div class="page-name__inner">
      ...
      <p class="page-name__caption"><?php _e("page-caption.wp-business", 'wp-next-landing-page'); ?></p>
    </div>
  </section>
  <section class="container__inner form-section">
    <p class="form-section__note">下記フォームへ必要事項をご記入の上、送信ボタンをクリックしてください。</p>
    <?php echo do_shortcode( '[contact-form-7 id="848" title="Contact Form_Business"]' ); ?>
  </section>
</div>
<footer>
