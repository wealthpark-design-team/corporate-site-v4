...
<article id="post-<?php the_ID(); ?>" class="blog-content">
	<div class="news-detail-box">
      ...
      <?php $terms = get_the_terms( $post->ID, 'news_category' );?>
		...
		<p class="blog-content__header-date"><?php echo get_the_date("Y.n.j"); ?></p>
		</section>
    <!-- .entry-header -->
		...
		<nav class="nav-links">
			...
			<div class="back-text"><a href="<?php echo get_post_type_archive_link( 'news' ); ?>"><?php _e("news_list_title", 'wp-next-landing-page') ?></a></div>
