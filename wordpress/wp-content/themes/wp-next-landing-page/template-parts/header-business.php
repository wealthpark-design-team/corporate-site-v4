...
<?php 
  ...
  $features_wpb_pocket = "不動産管理会社様向けモバイルアプリ<br>WPB ポケット";
      ...
      <ul class="menu__list">
        <li class="menu__list-item menu__first-level menu__parent-dropdown">
          ...
          <ul class="menu__dropdown">
            ...
            <li class="menu__dropdown-list-item">
              <a href="<?php echo esc_url(home_url('/')); ?>business/features/wpb-pocket/" class="menu__dropdown-list-link">
                <?php echo $features_wpb_pocket; ?>
              </a>
            </li>
          </ul>
        </li>
