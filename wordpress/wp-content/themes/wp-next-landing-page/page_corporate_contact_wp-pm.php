<?php
/*
Template Name: Corporate Site - Contact - WP PM
*/
?>
<!DOCTYPE html>
...
<title>Property management | <?php _e("corporate.meta-title.contact", 'wp-next-landing-page'); ?></title>
...
<!-- <div class="wealth-park-triangle"> -->
  ...
  <section class="page-name">
    <div class="page-name__inner">
      <h1 class="page-name__title--form page-name__title--form--reset-padding">WealthParkプロパティマネジメントへのお問い合わせ</h1>
    </div>
  </section>
  <div id="form-top"></div>
  <section class="container__inner form-section form-section-contact">
    ...
    <?php echo do_shortcode( '[contact-form-7 id="9214" title="Contact Form_Management_PM"]' ); ?>
