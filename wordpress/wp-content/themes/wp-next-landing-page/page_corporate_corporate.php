<?php
/*
Template Name: Corporate Site - Corporate
*/
?>
<!DOCTYPE html>
...
<div class="wealth-park-triangle">
  ...
  <section class="career-visual career-visual--company">
      <div class="career-visual__outer career-visual__outer--company">
        <video class="career-visual__video" poster="<?php echo get_template_directory_uri() ?>/corporate/img/company_profile_top_background.png">
        </video>
      </div>
    <div class="career-visual__txt">
      <h1 class="career-visual__title"><?php _e("page-caption.corporate", 'wp-next-landing-page'); ?></h1>
    </div>
    ...
    <div class="container__inner company-profile__inner">
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-1.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-1.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-2.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-2.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-3.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-3.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-5.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-5.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-7.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-7.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-10.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-10.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-8.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-8.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
      <dl class="company-profile__list">
        <dt class="company-profile__title">
          <?php _e("section.about.table.tr-9.th", 'wp-next-landing-page'); ?>
        </dt>
        <dd class="company-profile__body">
          <?php _e("section.about.table.tr-9.td", 'wp-next-landing-page'); ?>
        </dd>
      </dl>
    </div>
  </section>
