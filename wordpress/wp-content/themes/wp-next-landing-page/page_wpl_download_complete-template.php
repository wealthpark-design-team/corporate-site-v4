<?php
/*
Template Name: Service Page - WPL - Download - Completed
*/
?>
<!DOCTYPE html>
...
<title><?php _e("wpl_dl-completed_meta-title", 'wp-next-landing-page'); ?></title>
...
<section class="page-name">
  <div class="page-name__inner">
    <h2 class="page-name__title--form"><?php _e("wpl_dl-completed_title", 'wp-next-landing-page'); ?></h2>
  </div>
</section>
<section class="container__inner form-section">
  <p class="form-section__note"><?php _e("wpl_dl-completed_body", 'wp-next-landing-page'); ?></p>
</section>
<footer>
