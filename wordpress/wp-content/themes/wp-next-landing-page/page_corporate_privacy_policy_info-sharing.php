<?php
/*
Template Name: Corporate Site - Privacy Policy - Information Sharing
*/
?>
<!DOCTYPE html>
...
<section class="page-name">
  <div class="page-name__inner">
    ...
    <h1 class="page-name__subtitle"><?php _e("page-subtitle.privacy-policy.info-sharing", 'wp-next-landing-page'); ?></h1>
  </div>
</section>
<?php _e("corporate.privacy-policy.info-sharing.content", 'wp-next-landing-page'); ?>
<footer>
