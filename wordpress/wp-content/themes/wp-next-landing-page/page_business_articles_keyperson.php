<?php
/*
Template Name: Service Page - Business - Articles - KPV
*/
?>
<!DOCTYPE html>
  ...
  <div id="page" class="whole-page seminar-kpv-pr">
    ...
    <div id="content" class="site-content">
      <section class="seminar-kpv-pr__hero section-block">
        <img loading='lazy' class="seminar-kpv-pr__hero--img" src="<?php echo get_template_directory_uri() ?>/business/img/keyperson_hero-min.jpg" />
        ...
        <div id="section-blog-list">
          <section class="blog-articles">
            <div class="blog-articles__header">
              <h2 class="blog-articles__headline">Key Person's Voice</h2>
            </div>
            <?php
