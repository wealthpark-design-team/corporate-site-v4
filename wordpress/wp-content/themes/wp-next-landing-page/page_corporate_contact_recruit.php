<?php
/*
Template Name: Corporate Site - Contact - Recruit
*/
?>
<!DOCTYPE html>
...
<!-- <div class="wealth-park-triangle"> -->
  ...
  <section class="page-name">
    <div class="page-name__inner">
      <h1 class="page-name__title--form page-name__title--form--reset-padding"><?php _e("page-caption.recruit", 'wp-next-landing-page'); ?></h1>
    </div>
  </section>
  <div id="form-top"></div>
  <section class="container__inner form-section form-section-contact">
    ...
    <?php echo do_shortcode( '[contact-form-7 id="858" title="Contact Form_Recruit"]' ); ?>
