<?php
/*
Template Name: Corporate Site - Contact - PR
*/
?>
<!DOCTYPE html>
...
<!-- <div class="wealth-park-triangle"> -->
  ...
  <section class="page-name">
    <div class="page-name__inner">
      <h1 class="page-name__title--form page-name__title--form--reset-padding"><?php _e("page-caption.contact-pr", 'wp-next-landing-page'); ?></h1>
    </div>
  </section>
  <div id="form-top"></div>
