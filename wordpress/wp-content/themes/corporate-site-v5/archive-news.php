...
<div id="page" class="whole-page">
	...
	<div id="primary" class="content-area news_page">
        ...
        $pan->append("News", get_post_type_archive_link("news"));
        // $pan->build();
        if (have_posts()) : ?>

			<header class="page-header">
				<h1 class="page-title news-title">News<small><?php _e("news.all-news", 'wp-next-landing-page'); ?></small></h1>
			</header><!-- .page-header -->
			<ul class="news__list">
			  <?php
                        ...
                        <div class='news-item__link'>
                          <header class='news-item__header'>
                            ...
                            <div class='news-item__header-inner'>
                              <a class='news-item__header-cate' href='{$_(!empty($category) ? get_term_link($category[0]->term_id) : '#')}'>
