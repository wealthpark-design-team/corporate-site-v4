...
<?php endif; ?>
    ...
    <nav class="menu__navbar menu__navbar--pc">
      ...
      <ul class="menu__list">
        ...
        <li class="menu__list-item menu__first-level menu__parent-dropdown">
          <a class="menu__list-link menu__dropdown-toggle" href="javascript:void(0)"><?php echo $owner_sama; ?></a>
          <ul class="menu__dropdown menu__dropdown--edgex12">
            <li class="menu__dropdown-heading"><?php echo $owner_service; ?></li>
            <li class="menu__dropdown-list-item">
              <a href="https://owner.wealth-park.com/login" class="menu__dropdown-list-link">
                <?php echo $pcwp; ?>
              </a>
            </li>
            <li class="menu__dropdown-list-item">
              <a href="<?php echo esc_url(home_url('/')); ?>help_owner" class="menu__dropdown-list-link ">
                <?php echo $support_center; ?>
              </a>
            </li>
            <li class="menu__dropdown-list-item">
              <a href="<?php echo esc_url(home_url('/')); ?>business/pm-list/" class="menu__dropdown-list-link">
            ...
            <li class="menu__dropdown-heading"><?php echo $wp_about; ?></li>
            <li class="menu__dropdown-list-item">
            ...
            <li class="menu__dropdown-list-item">
              <a href="<?php echo esc_url(home_url('/')); ?>contact/owner/" class="menu__dropdown-list-link">
                <?php echo $contact; ?>
              </a>
            </li>
          </ul>
      ...
      <div class="menu__list-container">
        <ul class="menu__list--mobile">
          ...
          <li class="menu__list-item menu__first-level menu__parent-dropdown menu__first-level--last">
            <a class="menu__list-link menu__dropdown-toggle" href="javascript:void(0)"><?php echo $owner_service; ?></a>
            <ul class="menu__dropdown">
              <li class="menu__dropdown-list-item">
                <a href="https://owner.wealth-park.com/login" class="menu__dropdown-list-link">
                  <?php echo $pcwp; ?>
