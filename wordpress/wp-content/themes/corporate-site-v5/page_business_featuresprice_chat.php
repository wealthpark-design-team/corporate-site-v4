<?php
/*
Template Name: Service Page - Business - FeaturesPrice - chat
*/
?>
<!DOCTYPE html>
...
<title>チャットコミュニケーションについて | WealthParkビジネス</title>
<meta name="description" content="オーナーとのチャットコミュニケーションについて。不動産会社とオーナーをつなぐ、デジタルプラットフォーム「WealthParkビジネス」">
<meta property="og:image" content="<?php echo get_template_directory_uri() ?>/img/ogp/OGP_chat.jpg">
...
<section class="page-name">
  <div class="page-name__inner">
    <h1 class="page-name__title">チャットコミュニケーション</h1>
    <p class="page-name__caption">Chat</p>
  </div>
</section>
<!-- p-fp__oneColumn -->
<section class="p-fp__oneColumn">
  <div class="l-inner">
    <h2 class="p-fp__oneTit c-fp__tit">チャットを使ってオーナー様とコミュニケーション、社内での情報共有がよりスムーズに。</h2>
    <div class="p-fp__oneImg">
        <img loading='lazy' src="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_pic1.gif" alt="チャットを使ってオーナー様とコミュニケーション、社内での情報共有がよりスムーズに。">
    </div>
    <p class="p-fp__oneTxt">
      管理部門と売買部門の連携、退職メンバーの対応履歴など、オーナー様とのコミュニケーションをしっかり社内でシェアすることは、オーナー様へのサービス向上に不可欠。
      WealthPark のチャット機能を活用することで、関係者全員がしっかり情報を共有し、よりスムーズな連携が可能になります。
    </p>
  </div>
</section>
<!-- p-fp__oneColumn -->
  ...
  <div class="l-inner">
      <ul class="p-fp__twoTeams">
        <li class="p-fp__twoTeam">
            <h3 class="p-fp__twoTit c-fp__tit">個別連絡だけではなく、<br>一斉送信も可能</h3>
            <p class="p-fp__twoTxt">
              オーナー様一人ひとりとのコミュニケーションはもちろん、全オーナー様への緊急連絡や、一定のグループ毎にセミナー案内をするなど、
              様々な使い方が可能です。オーナー様にとっても、メッセージが届くとスマホに通知がされるので、
              見落としせずにすぐに返信が出来て安心です。
              もちろん、添付ファイルで見積書や写真を送る事も出来るので、様々な報告・承諾が完結出来ます。
            </p>
        </li>
        <li class="p-fp__twoTeam">
          <img loading='lazy' src="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_pic2.png" alt="個別連絡だけではなく、一斉送信も可能">
        </li>
      </ul>
  </div>
</section>
  ...
  <section class="p-fp__modal">
    <ul class="p-fp__modalTeams l-inner">
      <li class="p-fp__modalTeam">
        <dl class="p-fp__modalList">
          <dt class="p-fp__modalImg">
            <a href="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_modal_pic3.png" alt="チャット画面 (管理会社向けシステム)">
              <img loading='lazy' src="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_pic3.png" alt="チャット画面 (管理会社向けシステム)">
            </a>
          </dt>
      ...
      <li class="p-fp__modalTeam">
        <dl class="p-fp__modalList">
          <dt class="p-fp__modalImg">
            <a href="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_modal_pic4.png" alt="チャットトピックス一覧画面  (オーナー向けモバイルアプリ)">
              <img loading='lazy' src="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_pic4.png" alt="チャットトピックス一覧画面  (オーナー向けモバイルアプリ)">
            </a>
          </dt>
          <dd class="p-fp__modalTxt">
            チャットトピックス一覧画面  (オーナー向けモバイルアプリ)
          </dd>
        </dl>
      </li>
      <li class="p-fp__modalTeam">
        <dl class="p-fp__modalList">
          <dt class="p-fp__modalImg">
            <a href="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_modal_pic5.png" alt="チャット画面  (オーナー向けモバイルアプリ)">
              <img loading='lazy' src="<?php echo get_template_directory_uri() ?>/business/img/fp_chat_pic5.png" alt="チャット画面  (オーナー向けモバイルアプリ)">
            </a>
          </dt>
          <dd class="p-fp__modalTxt">
            チャット画面  (オーナー向けモバイルアプリ)
          </dd>
        </dl>
      </li>
    </ul>
