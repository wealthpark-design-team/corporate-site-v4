<?php
/*
Template Name: Service Page - Business - Articles - Seminars
*/
?>
<!DOCTYPE html>
...
<meta property="og:image" content="<?php echo get_template_directory_uri() ?>/img/ogp/OGP_seminar.jpg">
  ...
  <div id="page" class="whole-page seminar-kpv-pr">
    ...
    <div id="content" class="site-content">
      <section class="seminar-kpv-pr__hero section-block">
        <img loading='lazy' class="seminar-kpv-pr__hero--img" src="<?php echo get_template_directory_uri() ?>/business/img/seminar_hero-min.jpg" />
        ...
        <div id="section-blog-list">
          <section class="blog-articles">
            <div class="blog-articles__header">
              <h2 class="blog-articles__headline">セミナー申し込み</h2>
            </div>
            <?php
