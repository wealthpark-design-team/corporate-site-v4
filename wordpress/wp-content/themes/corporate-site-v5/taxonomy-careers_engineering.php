...
<div id="page" class="whole-page">
	...
	<div id="primary" class="content-area blog">
        ...
        $pan->append("CAREERS", home_url("/careers"));
        ...
        <h1 class="page-title blog-title">#<?=$obj->name ?> <small>CAREERS</small></h1>
			</header><!-- .page-header -->
			...
			<?php
                ...
                if ($query->have_posts()) {
                    ...
                    while ($query->have_posts()) {
                        $query->the_post();
                        $category = get_the_terms(get_the_ID(), "careers_engineering");
                        echo "
						<li class='blog-articles__item'>
							<div class='blog-articles__item-header'>
                <span class='blog-articles__item-category'>
                  {$_($current_lang == "ja" ? "エンジニア" : "Engineering")}
                </span>
